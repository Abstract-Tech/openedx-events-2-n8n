...
def send_user_data_to_webhook(
    ...
    """
    Trigger a task to send the user data to the n8n webhook.
    ...
    send_data_to_n8n.delay(settings.N8N_REGISTRATION_WEBHOOK, n8n_payload)
...
def send_enrollment_data_to_webhook(
    ...
    """
    Trigger a task to send the enrollment data to the n8n webhook.
    ...
    send_data_to_n8n.delay(settings.N8N_ENROLLMENT_WEBHOOK, n8n_payload)
...
def send_persistent_grade_course_data_to_webhook(
    ...
    """
    Trigger a task to send the grade data to the n8n webhook.
    ...
    send_data_to_n8n.delay(
        settings.N8N_PERSISTENT_GRADE_COURSE_WEBHOOK, n8n_payload
    )
