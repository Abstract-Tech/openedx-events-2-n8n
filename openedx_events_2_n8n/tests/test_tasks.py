...
@ddt
class SendDataToN8nTaskTest(TestCase):
    """
    ...
    @patch("openedx_events_2_n8n.tasks.post")
    def test_send_data_to_n8n_task_failure(self, post_mock):
        """
        Test that send_data_to_n8n raises an exception when the request fails.
