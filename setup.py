#!/usr/bin/env python
"""
Package metadata for openedx_events_2_n8n.
"""
import os
import re
import sys
...
VERSION = get_version("openedx_events_2_n8n", "__init__.py")
...
setup(
    name="openedx-events-2-n8n",
    version=VERSION,
    description="""This repository contains real-life use cases for Open edX Events.""",
    ...
    entry_points={
        "lms.djangoapp": [
            "openedx_events_2_n8n = openedx_events_2_n8n.apps:OpenedxEvents2N8nConfig",
        ],
    },
)
