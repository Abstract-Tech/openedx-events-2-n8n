...
project = "Open edX Events 2 n8n"
copyright = f"{datetime.datetime.now(tz=datetime.timezone.utc).year}, Abstract Technology"
...
html_theme_options = {
    "repository_url": "https://github.com/Abstract-Tech/openedx-events-2-n8n",
